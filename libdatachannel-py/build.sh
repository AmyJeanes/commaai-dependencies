...
# the package's CMake clones libdatachannel and its submodules into _deps, where some test fixture paths exceed
# Windows' 260-character limit; git needs core.longpaths for them (set through the environment, not the user's config)
